...
class _FeatureDiscoveryScreenState extends State<FeatureDiscoveryScreen> {
  ...
  final List<Map<String, dynamic>> _slides = [
    ...
    },
    {
      ...
      'desc': 'Alimentato dal modello ${BCSecurity.groqModel} di Groq. Inserisci la tua API Key nelle impostazioni per sbloccare la Super-Intelligenza culinaria.',
    },
    {
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Icon(
              _slides[i]['icon'] as IconData, 
              size: 80, 
              color: BC.getPrimary(context).withAlpha(200),
            ),
          ),
